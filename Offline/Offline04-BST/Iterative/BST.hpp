...
public:
    ...
    void iterInsert(const Key &k, const E &e)
    {
        BinNode<E> *newNode = new BSTNode<Key, E>(k, e, NULL, NULL);
        if (this->root == NULL)
        {
            this->root = newNode;
        }
        ...
        {
            BinNode<Key> *temp = this->root;
            while (true)
            {
                if (k < ((BSTNode<Key, E> *)temp)->key())
                {
                    if (temp->left() == NULL)
                    {
                        temp->left = newNode;
    ...
    E iterFind(const Key &k) const
    {
        ...
        {
            BinNode<Key> *temp = this->root;
            while (k != ((BSTNode<Key, E> *)temp)->key())
            {
                if (k < ((BSTNode<Key, E> *)temp)->key())
                {
                    if (temp->left() == NULL)
    ...
    BinNode<E> *iterGetMin(BinNode<E> root)
    {
        if (root == NULL)
            return NULL;
        BinNode<E> *temp = root;
    ...
    BinNode<E> *iterDeleteMin(BinNode<E> root)
    {
        if (root == NULL)
            return NULL;
        BinNode<E> *temp = root;
    ...
    BinNode<E> *iterGetMax(BinNode<E> root)
    {
        if (root == NULL)
            return NULL;
        BinNode<E> *temp = root;
    ...
    E iterRemove(const Key &k)
    {
        ...
        else
        {
            ...
            BinNode<E> *target = this->root, *parent = NULL;
            while (k != ((BSTNode<Key, E> *)temp)->key())
            {
                parent = target;
                if (data < target->data)
            ...
            else
            {
                ...
                BNode *inSucc = iterGetMin(this->root);
                int value = inSucc->element();
                ...
                if (target == root)
                    ...
                    parent->left()->setElement(value);
                else if (target == parent->right())
                    parent->right()->setElement(value);
            }
        }*/
    }
};
